...
import Cart_page from "../pages/Customer_features/Cart_page"
...
// This component decides if the user can access the Cart page
// - Customer → show Cart_page
// - Other logged-in roles (Vendor/Shipper/etc.) → show Access_denied_page
// - Guest (not logged in) → redirect to login

function Cart_page_route() {
    ...
    useEffect(() => {
        ...
        // Run the fetch once on component mount
        get_account_type()
    }, []);
    ...
    if (type === "Customer") return <Cart_page /> // Customer → cart page
...
export default Cart_page_route
