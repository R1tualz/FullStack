...
function My_account_customer() {
    const navigate = useNavigate()
    // Avatar state (preview URL + uploaded file)
    const [avatarUrl, setAvatarUrl] = useState(
        "https://api.dicebear.com/9.x/initials/svg?seed=Customer"
    );
    ...
    useEffect(() => {
        const get_user = async () => {
            ...
            const { name, username, address, avatar, account_type } = user_data.data
            setAvatarUrl(avatar)
            set_name(name)
            ...
            <div className="mx-auto max-w-3xl px-6 py-12">
                ...
                <section className="rounded-2xl border border-white bg-black/60">
                    ...
                    <dl className="grid grid-cols-1 gap-6 p-6 sm:grid-cols-2">
                        ...
                        <div className="rounded-xl border border-white bg-black/60 p-4">
                            <dt className="text-xs uppercase tracking-wide text-white/70">Name</dt>
                        ...
                        <div className="rounded-xl border border-white bg-black/60 p-4 sm:col-span-2">
                            <dt className="text-xs uppercase tracking-wide text-white/70">Address</dt>
...
export default My_account_customer;
